...
import { MarkType, parse } from './parser';
...
describe('parser', () => {
  it.each([
    ...
    [
      [
        { open: '##', close: '##', start: [0, 2], end: [53, 55], mark: { type: MarkType.Symbol, open: '##', content: { type: MarkType.Punctuation, open: '[[', close: ']]' } }, content:
    ...
    [
      [
        ...
        { open: '##', close: '##', start: [61, 63], end: [94, 96], mark: { type: MarkType.Symbol, open: '##', content: { type: MarkType.Punctuation, open: '[[', close: ']]' } }, content:
        ...
        { open: '##', close: '##', start: [224, 226], end: [299, 301], mark: { type: MarkType.Symbol, open: '##', content: { type: MarkType.Punctuation, open: '[[', close: ']]' } }, content:
            { open: '[[', close: ']]', start: [0, 2], end: [16, 18], mark: { open: '[[', close: ']]', type: MarkType.Punctuation } } },
      ],
    ...
    [
      [
        ...
        { open: '##', close: '##', start: [80, 82], end: [113, 115], mark: { type: MarkType.Symbol, open: '##', content: { type: MarkType.Punctuation, open: '[[', close: ']]' } }, content:
            { open: '[[', close: ']]', start: [0, 2], end: [16, 18], mark: { open: '[[', close: ']]', type: MarkType.Punctuation } } },
      ],
